(function ($, window, document, undefined) {
    ...
    ComboTree.prototype.initevent = function () {
		...
		$(".title-group-name").click(function(e){
			//$(this.element).find('div[_id=role_select]');
			//alert(e.target.textContent);
			var oliId = $(this).parent().parent().attr("data-id");
			...
			$("#comboValue").empty();
			$("#comboValue").append(item);
			_this.hideul();
			//_this.checkrow(e.target, e.target.textContent, false);
			//$("role_select");
			//_this.hideul();
		});
		...
		//$(_this.element).find('.title-group-name').on('click', function (event) {
    ...
    ComboTree.prototype.initdom = function () {
        $(this.element).append(
            ...
            '<div _id="role_select" id="comboValue" class="select-menu-input imitationSelect role_select">'+
    ...
    $.fn[comboTreePlugin] = function (options) {
        ...
        this.each(function () {
            if (!$.data(this, 'plugin_' + comboTreePlugin)) {
				...
				$.data(this, 'plugin_' + comboTreePlugin, null);
            }
        });
